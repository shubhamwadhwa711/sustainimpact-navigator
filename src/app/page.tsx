      ...
      <div className="p-10  border border-b-gray-600 ">
        <div className=" flex flex-row sm:flex-col ">
          <div className="flex w-full sm:mb-2 sm:justify-center">
            <p className="lg:text-4xl md:text-2xl sm:text-2xl font-semibold sm:self-center">Open Initiatives</p> <span className=" sm:ml-2 ml-4 rounded flex font-semibold sm:p-2 md:p-4 lg:p-6 items-center justify-center text-white bg-zinc-500">12</span>
          </div>
        ...
        <div className=" flex flex-row sm:mt-4 sm:flex-col mt-10">
          <div className="flex w-full sm:mb-2 sm:justify-center">
            <p className="lg:text-4xl md:text-2xl sm:text-2xl font-semibold sm:self-center">Closed Initiatives</p> 
            <span className=" sm:ml-2 ml-4 rounded flex font-semibold sm:p-2 md:p-4 lg:p-6 items-center justify-center text-white bg-zinc-500">6</span>
          </div>
